...
const VALUES = [
  { icon: 'Map', title: 'Кемпинги и автокемпинги', text: 'Формируем сеть сертифицированных объектов размещения по всей стране.' },
  { icon: 'Truck', title: 'Индустрия каравания', text: 'Развиваем рынок автодомов, прицепов и оборудования для каравана.' },
  { icon: 'Users', title: 'Профессиональное сообщество', text: 'Объединяем операторов, производителей и путешественников.' },
        ...
        <div className="container relative z-10 py-24">
          <div className="max-w-3xl animate-fade-in">
            ...
            <p className="text-gold uppercase tracking-[0.3em] text-sm mb-6">
              Зарегистрирован 12 января 2023 года · Москва
            </p>
            ...
            <p className="text-white/70 text-lg md:text-xl leading-relaxed mb-10 max-w-2xl">
              Отраслевое некоммерческое объединение профессионалов индустрии
              кэмпинга и каравана. Развиваем инфраструктуру, формируем стандарты
              и представляем интересы отрасли на государственном уровне.
            </p>
        ...
        <div className="container grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <h2 className="font-serif text-4xl md:text-5xl leading-tight mb-8">
              Профессиональное сообщество индустрии кэмпинга и каравана
            </h2>
            <div className="space-y-5 text-navy/70 text-lg leading-relaxed">
              <p>
                НСПИКА — Национальный союз профессионалов индустрии кемпингов и автотуризма,
                зарегистрированный в 2023 году в Москве. Мы объединяем операторов кемпингов,
                производителей и дистрибьюторов карavan-техники, туристических прицепов
                и автодомов, а также организаторов автомобильных путешествий.
              </p>
              <p>
                Союз разрабатывает отраслевые стандарты, ведёт реестр сертифицированных
                объектов размещения, содействует развитию инфраструктуры каравания
                в России и представляет интересы профессионального сообщества в органах
