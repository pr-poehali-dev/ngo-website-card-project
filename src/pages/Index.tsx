...
const NEWS = [
  {
    date: '24 июня 2026',
    tag: 'Стандарты',
    title: 'Утверждены отраслевые стандарты классификации кемпингов и глэмпингов',
    text: 'Документ устанавливает единые требования к инфраструктуре, безопасности и сервису объектов — от кемпстоянок до глэмпинг-парков.',
  },
  {
    date: '11 июня 2026',
    tag: 'Мероприятия',
    title: 'Итоги съезда профессионалов автомототуризма и каравана',
    text: 'Ведущие эксперты отрасли обсудили развитие сети кемпингов, поддержку экспедиционного туризма и меры для популяризации автодомов.',
  },
  {
    date: '02 июня 2026',
    tag: 'Развитие',
    title: 'Открыт приём заявок в реестр сертифицированных объектов размещения',
    text: 'Кемпинги, глэмпинги, кемпстоянки и базы отдыха могут пройти добровольную сертификацию НСПКА и войти в национальный реестр.',
  },
];

const VALUES = [
  { icon: 'Map', title: 'Кемпинги и глэмпинги', text: 'Формируем сеть сертифицированных объектов: кемпинги, глэмпинги, кемпстоянки, базы отдыха.' },
  { icon: 'Truck', title: 'Индустрия каравания', text: 'Развиваем рынок автодомов, прицепов-дач и оборудования для путешествий.' },
  { icon: 'Compass', title: 'Экспедиции и автотуризм', text: 'Поддерживаем экспедиционный туризм, природные маршруты и экотуризм.' },
  { icon: 'Landmark', title: 'Диалог с государством', text: 'Единственная в России профессиональная организация в автомототуризме и праве голоса в органах власти.' },
];
        ...
        <div className="container relative z-10 py-24">
          <div className="max-w-3xl animate-fade-in">
            ...
            <p className="text-white/70 text-lg md:text-xl leading-relaxed mb-10 max-w-2xl">
              Единственная в России профессиональная организация в автомототуризме
              и праве: объединяем ведущих экспертов кемпинга, глэмпинга,
              кемпстоянок, экотуризма и индустрии каравана.
            </p>
        ...
        <div className="container grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <h2 className="font-serif text-4xl md:text-5xl leading-tight mb-8">
              Единственная профессиональная организация в автомототуризме и праве каравана
            </h2>
            <div className="space-y-5 text-navy/70 text-lg leading-relaxed">
              <p>
                НСПКА — Национальный союз профессионалов индустрии кемпингов и автотуризма,
                зарегистрированный в 2023 году в Москве (ИНН 9703128882). Объединяем ведущих
                экспертов отрасли: операторов кемпингов, глэмпингов и кемпстоянок,
                производителей автодомов и прицепов-дач, организаторов экспедиций
                и экотуризма на природных территориях.
              </p>
              <p>
                Союз разрабатывает отраслевые стандарты, ведёт реестр сертифицированных
                объектов размещения, оказывает экспертизу проектов, поддерживает регионы
                в развитии туристической инфраструктуры и представляет интересы
                профессионального сообщества в органах государственной власти.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-10 pt-8 border-t border-white/10">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ИНН 9703128882 · Зарегистрирован 12.01.2023 · г. Москва
              </p>
            </div>
          </div>
      ...
      <footer className="bg-navy text-white border-t border-white/10">
        <div className="container py-10 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-white/40 text-sm text-center">
            © 2026 Национальный союз профессионалов индустрии кемпингов и автотуризма · ИНН 9703128882
          </p>
        </div>
      </footer>
    </div>
